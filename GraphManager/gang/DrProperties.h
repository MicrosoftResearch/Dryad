...
const UINT16 DrProp_ChannelErrorCode =          DRPROP_SHORTATOM(0x4009);
const UINT16 DrProp_ChannelErrorString =        DRPROP_LONGATOM(0x400a);
...
const UINT16 DrProp_VertexErrorString =         DRPROP_LONGATOM(0x4020);
