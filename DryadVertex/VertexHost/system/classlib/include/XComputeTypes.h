...
--*/
typedef DR_ASYNC_INFO        XC_ASYNC_INFO;
typedef XC_ASYNC_INFO*       PXC_ASYNC_INFO;
...
--*/
typedef struct tagXDRESSIONHANDLE
{
    ULONG_PTR       Unused;
} *XDRESSIONHANDLE, **PXDRESSIONHANDLE;
const XDRESSIONHANDLE INVALID_XDRESSIONHANDLE = NULL;
...
--*/
#define XCTIMEINTERVAL_INFINITE             _I64_MAX
...
typedef struct tagXC_PROCESSPROPERTY_INFO{
    SIZE_T              Size;
    PCSTR               pPropertyLabel;    
    UINT64              PropertyVersion;
    PCSTR               pPropertyString;
    SIZE_T              PropertyBlockSize;
    PVOID               pPropertyBlock;
...
--*/
typedef struct tagXC_PROCESS_STATISTIDR{
    SIZE_T          Size;
    DWORD           Flags;
    ...
    UINT64          TotalIo;    
} XC_PROCESS_STATISTIDR, *PXC_PROCESS_STATISTIDR;
typedef const XC_PROCESS_STATISTIDR* PCXC_PROCESS_STATISTIDR;
...
typedef struct tagXC_SETANDGETPROCESSINFO_REQINPUT{
    ...
    SIZE_T                      NumberOfProcessPropertiesToSet;    
...
Fields:
    ...
    pProcessStatistics                        
                    Pointer to the XC_PROCESS_STATISTIDR struct
...
typedef struct tagXC_PROCESS_INFO{
    ...
    PCSTR                       pCommandLine;
    PXC_PROCESS_STATISTIDR      pProcessStatistics;
