...
namespace Microsoft.Research.DryadLinq.Internal
{
    ...
    public static class HpcLinqEnumerable
    {
        ...
        // Operator: SelectWithPartitionIndex
        public static IEnumerable<T2>
            SelectWithPartitionIndex<T1, T2>(this IEnumerable<T1> source,
                                             Func<T1, int, T2> procFunc)
        {
            foreach (T1 x in source)
            {
                yield return procFunc(x, 0);
            }
        }
        ...
        {
            return HpcLinqVertex.AsEnumerable(source.LongCount(predicate));
        }
        ...
        {
            return HpcLinqVertex.AsEnumerable(source.First());
        }
        ...
        public static IEnumerable<TSource>
            FirstAsQuery<TSource>(this IEnumerable<TSource> source,
                                  Func<TSource, bool> predicate)
        {
            return HpcLinqVertex.AsEnumerable(source.First(predicate));
        }

        public static IEnumerable<TSource> LastAsQuery<TSource>(this IEnumerable<TSource> source)
        {
            return HpcLinqVertex.AsEnumerable(source.Last());
        }
        ...
        public static IEnumerable<TSource>
            LastAsQuery<TSource>(this IEnumerable<TSource> source,
                                 Func<TSource, bool> predicate)
        {
            return HpcLinqVertex.AsEnumerable(source.Last(predicate));
        }

        public static IEnumerable<TSource> SingleAsQuery<TSource>(this IEnumerable<TSource> source)
        {
            return HpcLinqVertex.AsEnumerable(source.Single());
        }
        ...
        public static IGrouping<K, T>
            MakeHpcLinqGroup<K, T>(K key, IEnumerable<IGrouping<K, T>> groups)
        {
            return new HpcLinqGrouping<K, T>(key, FlattenGroups(groups));
        }
