...
{
    public unsafe sealed class HpcTextReader
    {
        ...
        public HpcTextReader(NativeBlockStream stream, Encoding encoding)
        {
        ...
        public HpcTextReader(IntPtr vertexInfo, UInt32 portNum)
            : this(new HpcLinqChannel(vertexInfo, portNum, true), Encoding.UTF8)
        {
        }

        public HpcTextReader(IntPtr vertexInfo, UInt32 portNum, Encoding encoding)
